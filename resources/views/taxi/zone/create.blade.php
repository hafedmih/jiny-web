                            ...
                            @csrf
                                <div class="tab-content" id="main_form">
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step5">
                                        <table class="table" id="open_trip"><tr><td><h1>Loading...</h1></td></tr></table>
                                    ...
                                    <div class="tab-pane" role="tabpanel" id="step6">
                                        ...
                                        <ul class="list-inline pull-right text-right">
                                            <li><button type="button" class="btn btn-danger prev-step">Back</button><button type="submit" id="submit" class="btn btn-success next-step ml-2" id="step6">Finish</button></li>
                                        </ul>
                                    </div>
