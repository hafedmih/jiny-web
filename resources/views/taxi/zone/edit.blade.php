                            ...
                            <div class="wizard">
                                <div class="wizard-inner">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" class="disabled">
                                            <a href="#step5" data-toggle="tab" aria-controls="step5" role="tab"><span class="round-tab icon-cash"></span> <i>Surge Price</i></a>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-content" id="main_form">
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step3">
                                            ...
                                            @foreach($zone->getZonePrice as $key => $values)
                                                ...
                                                <select name="ridenow_base_distance[{{$key}}]" id="ridenow_base_distance_0" class="form-control" required><option value="" selected disabled>Select Base Distance</option>@for ($i = 1; $i < 15; $i++)<option value="{{$i}}" @if($values->ridenow_base_distance == $i) selected  @endif>{{$i}}</option>@endfor</select>
                                                ...
                                                <div class="col-md-4"><div class="form-group"><label><b>Ride Now Booking Base Fare</b><span class="text-danger">*</span>:</label><input type="text" name="ridenow_booking_base_fare[{{$key}}]" value="{{$values->ridenow_booking_base_fare}}" id="ridenow_booking_base_fare_{{$key}}" placeholder="Ride Now Booking Base Fare" class="form-control" required></div></div>

                                                  <div class="col-md-4"><div class="form-group"><label><b>Ride Now Booking Base Per Kilometer</b><span class="text-danger">*</span>:</label><input type="text" name="ridenow_booking_base_per_kilometer[{{$key}}]" value="{{$values->ridenow_booking_base_per_kilometer}}" placeholder="Ride Now Booking Base Per Kilometer" class="form-control" id="ridenow_booking_base_per_kilometer_{{$key}}" required></div></div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step4">
                                            ...
                                            @foreach($zone->getZonePrice as $key => $values)
                                                ...
                                                <div class="col-md-4"><div class="form-group"><label><b>Ride Later Admin Commission</b><span class="text-danger">*</span>:</label><input type="text" name="ridelater_admin_commission[{{$key}}]" id="ridelater_admin_commission_{{$key}}" value="{{$values->ridelater_admin_commission}}" placeholder="Admin Commission" class="form-control" required></div></div>
                                                  ...
                                                  <div class="col-md-4"><div class="form-group"><label><b>Ride Later Booking Base Fare</b><span class="text-danger">*</span>:</label><input type="text" name="ridelater_booking_base_fare[{{$key}}]" id="ridelater_booking_base_fare_{{$key}}" value="{{$values->ridelater_booking_base_fare}}" placeholder="Ride Later Booking Base Fare" class="form-control" required></div></div>

                                                  <div class="col-md-4"><div class="form-group"><label><b>Ride Later Booking Base Per Kilometer</b><span class="text-danger">*</span>:</label><input type="text" name="ridelater_booking_base_per_kilometer[{{$key}}]" id="ridelater_booking_base_per_kilometer_{{$key}}" value="{{$values->ridelater_booking_base_per_kilometer}}" placeholder="Ride Later Booking Base Per Kilometer" class="form-control" required></div></div>
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step5">
                                            <table class="table" id="surge_price">
                                                <tr><td></td><td><label><b>Surge Price</b></label></td><td><label><b>Surge Distance Price</b></label></td><td><label><b>Start Time</b></label></td><td><label><b>End Time</b></label></td><td><label><b>Available Days</b></label></td></tr>
                                                @foreach($zone->getZonePrice as $key => $values)
...
$(document).ready(function() {
    ...
    $(document).ready(function () {
        ...
        $(".next-step").click(function (e) {
            ...
            if(step == 'step3'){
                var i = 0;
                var array = ['ridenow_base_price','ridenow_base_distance','ridenow_price_per_distance','ridenow_price_per_time','ridenow_free_waiting_time','ridenow_free_waiting_time_after_start','ridenow_waiting_charge','ridenow_cancellation_fee','ridenow_admin_commission_type','ridenow_admin_commission','ridenow_booking_base_fare','ridenow_booking_base_per_kilometer'];
                jQuery.each( array, function( key, value ) {
            ...
            if(step == 'step4'){
                var i = 0;
                var array = ['ridelater_base_price','ridelater_base_distance','ridelater_price_per_distance','ridelater_price_per_time','ridelater_free_waiting_time','ridelater_free_waiting_time_after_start','ridelater_waiting_charge','ridelater_cancellation_fee','ridelater_admin_commission_type','ridelater_admin_commission','ridelater_booking_base_fare','ridelater_booking_base_per_kilometer'];
                jQuery.each( array, function( key, value ) {
                    for (let index = 0; index < types; index++) {
                        if($("#"+value+"_"+index).val() == ""){
                            $("#"+value+"_"+index).next("samp").remove();
...
if(message){
    ...
    $(document).on('change','#vehicle_type',function(){
        ...
        var form1 = "";
        var form2 = "";
        var form3 = "<tr><td></td><td><label><b>Surge Price</b></label></td><td><label><b>Start Time</b></label></td><td><label><b>End Time</b></label></td><td><label><b>Available Days</b></label></td></tr>";
        var s= 0;
        $("#ride_now").html(form1);
