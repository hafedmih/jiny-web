...
if(message){
    ...
    $(document).on('change','#vehicle_type',function(){
        ...
        var form1 = "";
        var form2 = "";
        var form3 = "<tr><td></td><td><label><b>Surge Price</b></label></td><td><label><b>Start Time</b></label></td><td><label><b>End Time</b></label></td><td><label><b>Available Days</b></label></td><td></td></tr>";
        var s= 0;
        $("#ride_now").html(form1);
    ...
    $(document).on('click','.reset-slug',function(){
        var id = $(this).attr('id');
        $('input[type=text].sruge_price['+id+'][0]').val('');
        $('input[type=text].surge_distance_price['+id+'][0]').val('');
        $('input[type=text].available_days['+id+'][0]').val('');
        $('input[type=text].start_time['+id+'][0]').val('');
        $('input[type=text].end_time['+id+'][0]').val('');
    });
