                            ...
                            <div class="wizard">
                                <div class="wizard-inner">
                                    ...
                                    <ul class="nav nav-tabs" role="tablist">
                                        ...
                                        <li role="presentation" class="disabled">
                                            <a href="#step5" data-toggle="tab" aria-controls="step5" class="disable" role="tab"><span class="round-tab icon-city"></span> <i>Open Trip</i></a>
                                        </li>
                                        <li role="presentation" class="disabled">
                                            <a href="#step6" data-toggle="tab" aria-controls="step6" class="disable" role="tab"><span class="round-tab icon-cash"></span> <i>Surge Price</i></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                @csrf<input name="zone_id" id="zone_id" value="{{$zone->id}}" type="hidden" />
                                    <div class="tab-content" id="main_form">
                                        ...
                                        <div class="tab-pane" role="tabpanel" id="step5">
                                            <table class="table" id="open_trip">
                                            @foreach($zone->getZonePrice as $key => $values)
                                                <tr><td><label class="text-uppercase font-size-sm font-weight-bold">{{$values->getType->vehicle_name}}</label></td><td><div class="row"><div class="col-md-6"><div class="form-group"><label><b class="base_price">Base Price ({{$zone->unit}})</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_price[{{$key}}]" id="open_base_price_{{$key}}" value="{{$values->open_base_price}}" placeholder="Base Price" class="form-control" required></div></div><div class="col-md-6"><div class="form-group"><label><b>Base Distance</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_distance[{{$key}}]" value="{{$values->open_base_distance}}" id="open_base_distance_{{$key}}" placeholder="Base Distance (Ex: 0.5)" class="form-control" required></div></div></div><div class="row"><div class="col-md-6"><div class="form-group"><label><b class="price_per_distance">Price per Distance ({{$zone->unit}})</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_distance[{{$key}}]" id="open_price_per_distance_{{$key}}" value="{{$values->open_price_per_distance}}" placeholder="Price per Distance" class="form-control" required></div></div><div class="col-md-6"><div class="form-group"><label><b>Price per time</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_time[{{$key}}]" id="open_price_per_time_{{$key}}" value="{{$values->open_price_per_time}}" placeholder="Price per time" class="form-control" required></div></div></div><div class="row"><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time (Minutes)</b><span class="text-danger">*</span>:</label><input type="text" name="open_free_waiting_time[{{$key}}]" id="open_free_waiting_time_{{$key}}" value="{{$values->open_free_waiting_time}}" placeholder="Free Waiting time" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time After Start (Minutes)</b><span class="text-danger">*</span>:</label><input type="text" name="open_free_waiting_time_after_start[{{$key}}]" id="open_free_waiting_time_after_start_{{$key}}" value="{{$values->open_free_waiting_time_after_start}}" placeholder="Free Waiting time After Start" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Waiting Charge</b><span class="text-danger">*</span>:</label><input type="text" name="open_waiting_charge[{{$key}}]" id="open_waiting_charge_{{$key}}" value="{{$values->open_waiting_charge}}" placeholder="Waiting Change" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Cancellation fee</b><span class="text-danger">*</span>:</label><input type="text" name="open_cancellation_fee[{{$key}}]" id="open_cancellation_fee_{{$key}}" value="{{$values->open_cancellation_fee}}" placeholder="Cancellation Fee" class="form-control" required></div></div>
                                                 <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label><b>Admin commission type</b><span class="text-danger">*</span></label>
                                                            <select class="form-control" name="open_admin_commission_type[{{$key}}]" id="open_admin_commission_type_{{$key}}" required>
                                                                <option value="1" {{(old('open_admin_commission_type',1) == 1 )?'selected':''}} @if($values->open_admin_commission_type == '1') selected  @endif >
                                                                    Percentage</option>
                                                                <option value="0" {{(old('open_admin_commission_type',1) == 0 )?'selected':''}} @if($values->open_admin_commission_type == '0') selected  @endif >
                                                                    Fixed </option>
                                                            </select>
                                                    </div>
                                                </div>

                                                <div class="col-md-4"><div class="form-group"><label><b>Admin Commission</b><span class="text-danger">*</span>:</label><input type="text" name="open_admin_commission[{{$key}}]" id="open_admin_commission_{{$key}}" value="{{$values->open_admin_commission}}" placeholder="Admin Commission" class="form-control" required></div></div>

                                                </div></td><tr>
                                            @endforeach
                                            </table>
                                            <ul class="list-inline pull-right text-right">
                                                <li><button type="button" class="btn btn-danger prev-step">Back</button><button type="button" class="btn btn-success next-step ml-2" id="step5">Continue</button></li>
                                            </ul>
                                        </div>
...
$(document).ready(function() {
    ...
    $(document).ready(function () {
        ...
        $(".next-step").click(function (e) {
            ...
            if(step == 'step5'){
                var i = 0;
                var array = ['open_base_price','open_base_distance','open_price_per_distance','open_price_per_time','open_free_waiting_time','open_free_waiting_time_after_start','open_waiting_charge','open_cancellation_fee','open_admin_commission_type','open_admin_commission'];
                jQuery.each( array, function( key, value ) {
                    for (let index = 0; index < types; index++) {
                        if($("#"+value+"_"+index).val() == ""){
                            $("#"+value+"_"+index).next("samp").remove();
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.success){
                        ...
                        form4 = '<tr><td><label class="text-uppercase font-size-sm font-weight-bold">'+data.datas.get_type.vehicle_name+'</label></td><td><div class="row"><div class="col-md-6"><div class="form-group"><label><b class="base_price">Base Price ('+unit+')</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_price['+s+']" id="open_base_price_'+s+'" placeholder="Base Price" class="form-control" value="'+data.datas.open_base_price+'" required></div></div><div class="col-md-6"><div class="form-group"><label><b>Base Distance</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_distance['+s+']" id="open_base_distance_'+s+'" class="form-control" required value="'+data.datas.open_base_distance+'"></div></div></div><div class="row"><div class="col-md-6"><div class="form-group"><label><b>Price per time</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_time['+s+']" id="open_price_per_time_'+s+'" value="'+data.datas.open_price_per_time+'" placeholder="Price per time" class="form-control" required></div></div><div class="col-md-6"><div class="form-group"><label><b class="price_per_distance">Price per Distance ('+unit+')</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_distance['+s+']" id="open_price_per_distance_'+s+'" value="'+data.datas.open_price_per_distance+'" placeholder="Price per Distance" class="form-control" required></div></div></div><div class="row"><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time (Minutes)</b>:</label><input type="text" name="open_free_waiting_time['+s+']" id="open_free_waiting_time_'+s+'" value="'+data.datas.open_free_waiting_time+'" placeholder="Free Waiting time" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time After Start (Minutes)</b>:</label><input type="text" name="open_free_waiting_time_after_start['+s+']" id="open_free_waiting_time_after_start_'+s+'" value="'+data.datas.open_free_waiting_time_after_start+'" placeholder="Free Waiting time After Start" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Waiting Change</b><span class="text-danger">*</span>:</label><input type="text" name="open_waiting_charge['+s+']" id="open_waiting_charge_'+s+'" value="'+data.datas.open_waiting_charge+'" placeholder="Waiting Change" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Cancellation fee</b><span class="text-danger">*</span>:</label><input type="text" name="open_cancellation_fee['+s+']" id="open_cancellation_fee_'+s+'" value="'+data.datas.open_cancellation_fee+'" placeholder="Cancellation Fee" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Admin commission type</b><span class="text-danger">*</span></label><select class="form-control" name="open_admin_commission_type['+s+']" id="open_admin_commission_type_'+s+'" required><option value="1" {{(old('open_admin_commission_type',1) == 1 )?'selected':''}} @if($values->open_admin_commission_type == '1') selected  @endif >Percentage</option><option value="0" {{(old('open_admin_commission_type',1) == 0 )?'selected':''}} @if($values->open_admin_commission_type == '0') selected  @endif >Fixed </option></select></div></div><div class="col-md-4"><div class="form-group"><label><b>Admin Commission</b><span class="text-danger">*</span>:</label><input type="text" name="open_admin_commission['+s+']" id="open_admin_commission_'+s+'" value="'+data.datas.open_admin_commission+'" placeholder="Admin Commission" class="form-control" required></div></div></div></td><tr>';
                        ...
                        form4 = '<tr><td><label class="text-uppercase font-size-sm font-weight-bold">'+data.vehicle.vehicle_name+'</label></td><td><div class="row"><div class="col-md-6"><div class="form-group"><label><b class="base_price">Base Price (Kilometer)</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_price['+s+']" id="open_base_price_'+s+'" placeholder="Base Price" class="form-control" required></div></div><div class="col-md-6"><div class="form-group"><label><b>Base Distance</b><span class="text-danger">*</span>:</label><input type="text" name="open_base_distance['+s+']" id="open_base_distance_'+s+'" class="form-control" required value=""></div></div></div><div class="row"><div class="col-md-6"><div class="form-group"><label><b>Price per time</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_time['+s+']" id="open_price_per_time_'+s+'" placeholder="Price per time" class="form-control" required></div></div><div class="col-md-6"><div class="form-group"><label><b class="price_per_distance">Price per Distance (Kilometer)</b><span class="text-danger">*</span>:</label><input type="text" name="open_price_per_distance['+s+']" id="open_price_per_distance_'+s+'" placeholder="Price per Distance" class="form-control" required></div></div></div><div class="row"><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time (Minutes)</b>:</label><input type="text" name="open_free_waiting_time['+s+']" id="open_free_waiting_time_'+s+'" placeholder="Free Waiting time" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Free Waiting time After Start (Minutes)</b>:</label><input type="text" name="open_free_waiting_time_after_start['+s+']" id="open_free_waiting_time_after_start_'+s+'" placeholder="Free Waiting time After Start" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Waiting Change</b><span class="text-danger">*</span>:</label><input type="text" name="open_waiting_charge['+s+']" id="open_waiting_charge_'+s+'" placeholder="Waiting Change" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Cancellation fee</b><span class="text-danger">*</span>:</label><input type="text" name="open_cancellation_fee['+s+']" id="open_cancellation_fee_'+s+'" placeholder="Cancellation Fee" class="form-control" required></div></div><div class="col-md-4"><div class="form-group"><label><b>Admin commission type</b><span class="text-danger">*</span></label><select class="form-control" name="open_admin_commission_type['+s+']" id="open_admin_commission_type_'+s+'" required><option value="1" {{(old('open_admin_commission_type',1) == 1 )?'selected':''}} @if($values->open_admin_commission_type == '1') selected  @endif >Percentage</option><option value="0" {{(old('open_admin_commission_type',1) == 0 )?'selected':''}} @if($values->open_admin_commission_type == '0') selected  @endif >Fixed </option></select></div></div><div class="col-md-4"><div class="form-group"><label><b>Admin Commission</b><span class="text-danger">*</span>:</label><input type="text" name="open_admin_commission['+s+']" id="open_admin_commission_'+s+'" placeholder="Admin Commission" class="form-control" required></div></div></div></td><tr>';

                        form3 = '<tr class="'+data.vehicle.slug+'"><td rowspan="1"><label class="text-uppercase font-size-sm font-weight-bold">'+data.vehicle.vehicle_name+'</label><br><button type="button" class="btn bg-green-400 btn-icon rounded-round legitRipple addrow" id="'+data.vehicle.slug+'" value="'+s+'" data-popup="tooltip" data-value="1" title="" data-placement="bottom" data-original-title="Add"> <i class="icon-plus3"></i> </button></td><td><input type="text" name="sruge_price['+s+'][0]" placeholder="Sruge Price" class="form-control" ><input type="hidden" name="sruge_price_id['+s+'][0]" value=""></td><td><input type="text" name="surge_distance_price['+s+'][0]" placeholder="Surge Distance Price" class="form-control"></td><td><input type="time" name="start_time['+s+'][0]" class="form-control" ></td><td><input type="time" name="end_time['+s+'][0]" class="form-control" ></td><td><select name="available_days['+s+'][0][]" id="available_days_'+s+'_0" multiple="multiple" class="form-control" ><option value="Sunday">Sunday</option><option value="Monday">Monday</option><option value="Tuesday">Tuesday</option><option value="Wednesday">Wednesday</option><option value="Thursday">Thursday</option><option value="Friday">Friday</option><option value="Saturday">Saturday</option></select></td><td><button class="btn btn-danger reset-slug" type="button" id="'+s+'"><i class="icon-x"></i></button></td></tr>';
                    }
                    $("#ride_now").append(form1);
                    $("#ride_later").append(form2);
                    $("#open_trip").append(form4);
