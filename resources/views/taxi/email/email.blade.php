        ...
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <div class="list-icons">
                    @if(auth()->user()->can('new-email'))
                    <a href="{{ route('addemail') }}" class="btn bg-purple btn-sm legitRipple"><i class="icon-plus3 mr-2"></i> {{ __('add-new') }}</a>
                    @endif
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>        
                            @if(auth()->user()->can('delete-notification'))
                                <a href="" class="btn bg-purple-400 btn-icon rounded-round legitRipple" onclick="Javascript: return deleteAction('$emails->slug', `{{ route('emailDelete',$emails->slug) }}`)" data-popup="tooltip" title="" data-placement="bottom" data-original-title="Delete"> <i class="icon-trash"></i> </a>
                            @endif 
                        </td>
            ...
            <div class="modal-content">
                ...
                <form id="roleForm" name="roleForm" class="form-horizontal">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-md-6 required summernote">
                            <label class="col-form-label">{{ __('content') }}</label>
                            <input type="text" name="content" id="content" class="form-control"  placeholder="{{ __('content') }}" >
                        </div> -->
