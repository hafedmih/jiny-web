...
<div class="content row">
    ...
    <input type="hidden" id="zone" value="{{$zone->map_cooder}}" />
    <div class="card-form animated bounceInDown col-md-4" id="card_local_trip">
        <div class="card-header bg-white header-elements-inline">
            <!-- <h6 class="card-title">Create Trip</h6> -->
            <ul class="card-title nav nav-pills">
                <li class="nav-item"><a href="#solid-tab1" onclick="changeType('local')" class="nav-link rounded-round legitRipple @if($request_detail->trip_type == "LOCAL") active @else disabled @endif" data-toggle="tab">Local</a></li>
                <li class="nav-item"><a href="#solid-tab2" onclick="changeType('rental')" class="nav-link rounded-round legitRipple @if($request_detail->trip_type == "RENTAL") active @else disabled @endif" data-toggle="tab">Rental</a></li>
                <!-- <li class="nav-item"><a href="#solid-tab3" onclick="changeType('outstation')" class="nav-link rounded-round legitRipple @if($request_detail->trip_type == "OUTSTATION") active @else disabled @endif" data-toggle="tab">Out Station</a></li> -->
            </ul>
            @if($request_detail->trip_type == "LOCAL")
                <input type="hidden" id="trip_type" value="local" />
            @elseif($request_detail->trip_type == "RENTAL")
                <input type="hidden" id="trip_type" value="rental" />
            @elseif($request_detail->trip_type == "OUTSTATION")
                <input type="hidden" id="trip_type" value="outstation" />
            @endif
        ...
        <div class="tab-content">
            <div class="card tab-pane fade animated trip_content @if($request_detail->trip_type == "LOCAL") active show bounceInDown @endif" id="solid-tab1">
                <form class="wizard-form steps-validation" id="request_form" action="#" method="post" data-fouc autocomplete="off">
                    ...
                    <input type="hidden" name="ride_id" value="{{$request_detail->id}}" />
                    <h6>User Details</h6>
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="customer_number" onkeyup="myFunction()" id="customer_number" placeholder="Passenger Number" value="{{$request_detail->userDetail->phone_number}}" class="form-control required" onKeyPress="if(this.value.length==10) return false;">
                                    
                                    <input type="hidden" name="customer_slug" id="customer_slug" value="{{$request_detail->userDetail->slug}}" class="form-control">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_name" id="customer_name" value="{{$request_detail->userDetail->firstname}} {{$request_detail->userDetail->lastname}}" placeholder="Passenger Name" class="form-control required">
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-feedback form-group-feedback-right">
                                    ...
                                    <input type="text" name="pickup" id="pickup_point" onkeyup="getAddress('pickup')" class="form-control required type_location_input" value="{{$request_detail->requestPlace ?$request_detail->requestPlace->pick_address : ''}}" placeholder="Pickup Point">
                                    ...
                                    <input type="hidden" name="pickup_lat" id="pickup_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lat : ''}}">
                                    <input type="hidden" name="pickup_lng" id="pickup_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lng : ''}}">
                                    <input type="hidden" name="pickup_lng_id" id="pickup_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_up_id : ''}}">
                                </div>
                            </div>
                            <div class="col-md-12" id="add_rows">
                                <div class="form-group form-group-feedback form-group-feedback-right">
                                    <label>Stop Point: <span class="text-danger">*</span></label>
                                    <input type="text" name="stop" id="stop_point" onkeyup="getAddress('stop')" class="form-control type_location_input" placeholder="Stop Point" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->stop_address : ''}}">
                                    <div class="form-control-feedback form-control-feedback-lg" style="cursor: pointer;margin-top: 25px;">
                                        <i class="icon-sort change_button"></i>
                                        <i class="icon-cross" onclick="clearData('stop')" style="font-size:20px"></i>
                                    </div>
                                    <input type="hidden" name="stop_lat" id="stop_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->stop_lat : ''}}">
                                    <input type="hidden" name="stop_lng" id="stop_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->stop_lng : ''}}">
                                    <input type="hidden" name="stop_lng_id" id="stop_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->stop_id : ''}}">
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group form-group-feedback form-group-feedback-right">
                                    ...
                                    <input type="text" name="drop" id="drop_point" onkeyup="getAddress('drop')" class="form-control required type_location_input" placeholder="Drop Point" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_address : ''}}">
                                    <div class="form-control-feedback form-control-feedback-lg" style="cursor: pointer;margin-top: 25px;">
                                        <i class="icon-cross" onclick="clearData('drop')" style="font-size:20px"></i>  
                                    </div>
                                    <input type="hidden" name="drop_lat" id="drop_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_lat : ''}}">
                                    <input type="hidden" name="drop_lng" id="drop_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_lng : ''}}">
                                    <input type="hidden" name="drop_lng_id" id="drop_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_id : ''}}">
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="manual_trip" class="form-input-styled required" data-fouc value="MANUAL" @if($request_detail->manual_trip == "MANUAL") checked @endif>
                                            Manual
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="manual_trip" class="form-input-styled required" data-fouc value="AUTOMATIC" @if($request_detail->manual_trip == "AUTOMATIC") checked @endif>
                                            Automatic
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="trip_type" class="form-input-styled change-time required" onchange="getVehicles()" data-fouc value="RIDE_NOW" @if($request_detail->is_later == 0) checked @endif>
                                            Ride Now
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="trip_type" class="form-input-styled change-time required" onchange="getVehicles()" data-fouc value="RIDE_LATER" @if($request_detail->is_later == 1) checked @endif>
                                            Ride Later
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12" id="trip_date_time">
                                <div class="form-group">
                                    <label>Date & Time: <span class="text-danger">*</span> <span>{{$request_detail->trip_start_time}}</span></label>
                                    <input type="datetime-local" onblur="getVehicles()" name="ride_date_time" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="driver_notes" class="form-control">{{$request_detail->driver_notes}}</textarea>
                                </div>
                            </div>
                        </div>
                    </fieldset>
            ...
            <div class="card tab-pane fade animated trip_content @if($request_detail->trip_type == "RENTAL") active show bounceInDown @endif" id="solid-tab2">
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Passenger Number: <span class="text-danger">*</span></label>
                                    <input type="number" name="customer_number" onkeyup="myFunction1()" id="rental_customer_number" placeholder="Passenger Number" value="{{$request_detail->userDetail->phone_number}}" class="form-control required" onKeyPress="if(this.value.length==10) return false;">
                                    <input type="hidden" name="customer_slug" id="rental_customer_slug" value="{{$request_detail->userDetail->slug}}" class="form-control">
                                </div>
                                <div class="autocompletes">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Passenger Name: <span class="text-danger">*</span></label>
                                    <input type="text" name="customer_name" value="{{$request_detail->userDetail->firstname}} {{$request_detail->userDetail->lastname}}" id="rental_customer_name" placeholder="Passenger Name" class="form-control required">
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                    ...
                    <fieldset class="fieldset">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-feedback form-group-feedback-right">
                                    <label>{{ __('pickup_point') }}: <span class="text-danger">*</span></label>
                                    <input type="text" name="pickup" onkeyup="getAddress('rental_pickup')" id="rental_pickup_point" class="form-control required type_location_input" placeholder="Pickup Point" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_address : ''}}">
                                    <div class="form-control-feedback form-control-feedback-lg" style="cursor: pointer;margin-top: 25px;">
                                        <i class="icon-location3 get_location" style="font-size:20px"></i>
                                        <i class="icon-cross" onclick="clearData('pickup')" style="font-size:20px"></i>
                                    </div>
                                    <input type="hidden" name="pickup_lat" id="rental_pickup_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lat : ''}}">
                                    <input type="hidden" name="pickup_lng" id="rental_pickup_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lng : ''}}">
                                    <input type="hidden" name="pickup_lng_id" id="rental_pickup_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_up_id : ''}}">
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ __('rental_package') }} {{$request_detail->package_id}}: <span class="text-danger">*</span></label>
                                    <select class="form-control required" name="package" id="rental_package" onchange="getRentalItems()">
                                        <option value="">{{ __('rental_package') }}</option>
                                        @foreach($package_detail as $value)
                                            <option value="{{$value->slug}}" @if($request_detail->package_id == $value->id) selected @endif>{{$value->name}} ({{$value->km}} KM / {{$value->hours}} H)</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="trip_type" class="form-input-styled rental-change-time required"  data-fouc value="RIDE_NOW" @if($request_detail->ride_type == "Ride NOW") checked @endif>
                                            Ride Now
                                        </label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" name="trip_type" class="form-input-styled rental-change-time required" data-fouc value="RIDE_LATER" @if($request_detail->ride_type == "Ride Later") checked @endif>
                                            Ride Later
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12" id="rental_trip_date_time">
                                <div class="form-group">
                                    <label>Trip Date Time: <span class="text-danger">*</span> <span>{{date("d/m/Y  h:i:s a",strtotime($request_detail->trip_start_time))}}</span></label>
            ...
            <div class="card tab-pane fade animated trip_content @if($request_detail->trip_type == "OUTSTATION") active show bounceInDown @endif" id="solid-tab3">
                    ...
                    <fieldset>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Passenger Number: <span class="text-danger">*</span></label>
                                    <input type="number" name="customer_number" onkeyup="myFunction2()" id="outstation_customer_number" placeholder="Passenger Number" class="form-control required" value="{{$request_detail->userDetail->phone_number}}" onKeyPress="if(this.value.length==10) return false;">
                                    <input type="hidden" name="customer_slug" id="outstation_customer_slug" value="{{$request_detail->userDetail->slug}}" class="form-control">
                                </div>
                                <div class="autocompletes">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Passenger Name: <span class="text-danger">*</span></label>
                                    <input type="text" name="customer_name" value="{{$request_detail->userDetail->firstname}} {{$request_detail->userDetail->lastname}}" id="outstation_customer_name" placeholder="Passenger Name" class="form-control required">
                                </div>
                            </div>
                            <!-- <div class="col-md-12">
                                <div class="form-group">
                    ...
                    <fieldset class="fieldset">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-feedback form-group-feedback-right">
                                    <label>{{ __('pickup_point') }}: <span class="text-danger">*</span></label>
                                    <input type="text" name="pickup" onkeyup="getAddress('outstation_pickup')" id="outstation_pickup_point" class="form-control required type_location_input" placeholder="Pickup Point" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_address : ''}}">
                                    <div class="form-control-feedback form-control-feedback-lg" style="cursor: pointer;margin-top: 25px;">
                                        <i class="icon-location3 get_location" style="font-size:20px"></i>
                                        <i class="icon-cross" onclick="clearData('pickup')" style="font-size:20px"></i>
                                    </div>
                                    <input type="hidden" name="pickup_lat" id="outstation_pickup_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lat : ''}}">
                                    <input type="hidden" name="pickup_lng" id="outstation_pickup_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_lng : ''}}">
                                    <input type="hidden" name="pickup_lng_id" id="outstation_pickup_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->pick_up_id : ''}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ __('drop_point') }}: <span class="text-danger">*</span></label>
                                    <select class="form-control" name="drop" id="outstation_drop_point" onchange="assionPromoOutstation()">
                                        <option value="">{{ __('drop_point') }}</option>
                                        @foreach($outstanding_drops as $value)
                                            <option @if($request_detail->requestPlace && $request_detail->requestPlace->drop_address == $value->drop) selected @endif value="{{$value->drop}}">{{$value->drop}}</option>
                                        @endforeach
                                    </select>
                                    <input type="hidden" name="drop_lat" id="outstation_drop_point_lat" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_lat : ''}}">
                                    <input type="hidden" name="drop_lng" id="outstation_drop_point_lng" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_lng : ''}}">
                                    <input type="hidden" name="drop_lng_id" id="outstation_drop_point_lng_id" value="{{$request_detail->requestPlace ? $request_detail->requestPlace->drop_id : ''}}">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{ __('types') }}: <span class="text-danger">*</span></label>
                                    <select class="form-control" name="type" id="outstation_types" onchange="assionPromoOutstation()">
                                        <option value="">{{ __('types') }}</option>
                                        @foreach($outstation_price as $value)
                                            <option @if($request_detail->outstation_type_id == $value->id) selected @endif value="{{$value->id}}">{{$value->getVehicle->vehicle_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Trip Date Time: <span class="text-danger">*</span> <span>{{$request_detail->trip_start_time}}</span></label>
                                    <input type="datetime-local" name="ride_date_time" id="datetime" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    @if($request_detail->trip_type == "LOCAL")
        getVehicles();
        localTime();
        @if($request_detail->requestPlace && $request_detail->requestPlace->stop_address)
            $("#add_rows").show();
            $("#button_view").hide();
        @else
            $("#add_rows").hide();
    ...
    $(document).on('change',".rental-change-time",function(){
        var value = $(".rental-change-time").val();
        ...
        $.ajax({
            ...
            success: function (data) {
                if(data.data.length > 0){
                    ...
                    var item = "{{$request_detail->package_item_id}}";
                    // console.log(item);
                    $("#package_items").val(item);
                    assionPromoRental();
                }
            },
            error: function (xhr, ajaxOptions, thrownError) {
    ...
    function assionPromoRental(){
        // console.log($('#request_form1').serialize());
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data.success){
                    ...
                    $(".rental_price").after("<smapp class='text-danger'>"+data.data ? data.data.promo_msg : ''+"</small>")
                    $(".rental_price").show();
                }
    ...
    function assionPromoOutstation(){
        ...
        $.ajax({
            ...
            type: "GET",
            data: "promo_code="+outstation_pickup_point+"&drop="+outstation_drop_point+"&type="+type,
            dataType: 'json',
            success: function (data) {
    ...
    function changeType(value){
        ...
        // $("#button_view").hide();
        $(".autocompletes").hide();
        // $(".trip_content").addClass("bounceOutUp");
        if(value == 'local'){
                            ...
                            setInterval(function () {
                                $.ajax({
                                    ...
                                    success: function (datas) {
                                        ...
                                        else if(datas.data.is_cancelled == 1){
                                            swal({
                                                title: "{{ __('errors') }}",
                                                text: datas.message,
                                                icon: "error",
...
<script>
    ...
    function getAddress(even) {
        if(even == 'pickup'){
            ...
            if($("#rental_pickup_point").val().length > 3){ 
        ...
        // }
            ...
            if($("#outstation_pickup_point").val().length > 3){ 
    ...
    function route(){
        ...
        if(trip == 'local'){
            ...
            var lati = parseFloat($("#rental_pickup_point_lat").val());
            var long = parseFloat($("#rental_pickup_point_lng").val());
            markers = new google.maps.Marker({
...
// Map Nearby search//
<script src="https://maps.googleapis.com/maps/api/place/autocomplete/json? radius=50000 ? components=country:IN ? location=11.0150677%2C76.9824808 ? input= session('data') ? sensor=false ? key={{ config('app.map_key')}}"></script>
...
<script type="text/javascript">
    ...
    route();
        ...
        $.each( view_list, function( key, value ) {
            ...
            div1.innerHTML = `<div class="count_list"><b>${name}</b> : <b>${value}</b><div>`;
