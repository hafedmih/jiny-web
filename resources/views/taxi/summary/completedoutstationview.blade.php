...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">{{ __('completed_outstation_trip') }}</h5>
    ...
    <div class="card">
        <div class="card-body row">
            <div class="col-lg-11" >
                <form action="{{ route('CompletedOutstationView') }}" method="get">
            ...
            <div class="col-lg-1" >
                <a href="{{route('CompletedOutstationView')}}" class="nav-link " style="padding-top: 0px; padding-bottom: 0px;">
