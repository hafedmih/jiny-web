...
<div class="content">
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">{{ __('completed_rental_trip') }}</h5>
    ...
    <div class="card">
        <div class="card-body row">
            <div class="col-lg-11" >
                <form action="{{ route('CompletedRentalView') }}" method="get">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-2">
                            <select name="customer" id="customer" class="form-control">
                                    ...
                                    <option value="{{$customer->id}}" @if($request->customer == $customer->id) selected @endif>{{$customer->firstname }} {{ $customer->lastname}}</option>
                                    @endforeach
                                </select>     
                        </div>
                        <div class="col-lg-2">
                                <select name="driver" id="driver" class="form-control">
                                    ...
                                    <option value="{{$value->id}}" @if($request->driver == $value->id) selected @endif>{{$value->firstname.' '.$value->lastname}}</option>
                                    @endforeach
                                </select>
                            </div>
                        <div class="col-lg-2" >
            ...
            <div class="col-lg-1" >
                <a href="{{route('CompletedRentalView')}}" class="nav-link " style="padding-top: 0px; padding-bottom: 0px;">
                        ...
                        <tbody>
                            ...
                            @if($request->request_id)
                                <tr>
                                    ...
                                    <td>{!! $request->getTripKM ? $request->getTripKM->trip_start_km  : '' !!}</td>
                                    <td>{!! $request->pick_address ? $request->pick_address : '' !!}</td>
                                    <td>{!! $request->completed_at ? $request->completed_at : '' !!}</td>
                                    <td>{!! $request->getTripKM ? $request->getTripKM->trip_end_km : '' !!}</td>
