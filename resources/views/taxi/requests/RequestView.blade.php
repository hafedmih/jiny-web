    ...
    <div class="row">
        <div class="col-xl-4 col-md-6">
            <div class="card card-body">
                ...
                <div class="media">
                    @if($request->userInstantDetail)
                        <div class="media-body">
                            <div class="media-title font-weight-semibold">{{$request->userInstantDetail ? $request->userInstantDetail->firstname : ''}} {{$request->userInstantDetail ? $request->userInstantDetail->lastname : ''}}</div>
                            <span class="text-muted">{{$request->userInstantDetail ? $request->userInstantDetail->phone_number : ''}}</span><br>
                            <span class="text-muted">{{$request->userInstantDetail ? $request->userInstantDetail->email : ''}}</span>
                        </div>
                        <div class="ml-3">
                            <img src="{{$request->userInstantDetail && $request->userInstantDetail->profile_pic ? $request->userInstantDetail->profile_pic : asset('backend/global_assets/images/demo/users/face6.jpg') }}" width="72" height="72" alt="" id="user_image">
                        </div>
                    @elseif($request->userDetail)
                        <div class="media-body">
                            ...
                            @else
                                <div class="media-title font-weight-semibold"><a style="color:#222" href="#">{{$request->userDetail ? $request->userDetail->firstname : ''}} {{$request->userDetail ? $request->userDetail->lastname : ''}}</a></div>
                            @endif
            ...
            <div class="card card-body">
                ...
                <div class="media">
                    <div class="media-body">
                        ...
                        <span class="text-muted">Time : {{date("h:i:s A",strtotime($request->created_at))}}</span>
                        <br>
                    ...
                    <div class="ml-3">
                            ...
                            <br>
                            @if($request->is_instant_trip == 1)
                               Instant Trip: <label class="badge bg-success-400 align-top">{{ __('yes')}}</label>
                            @elseif($request->is_instant_trip == 0)
                               Instant Trip: <label class="badge bg-danger-400 align-top">{{ __('no')}}</label>
                            @endif
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                            ...
                            <ul class="media-list">
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted">{{date("d/m/Y  h:i:s a",strtotime($request->trip_start_time))}}</div>
                                    </div>
                                </li>   
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted">{{date("d/m/Y  h:i:s a",strtotime($request->accepted_at))}}</div>
                                    </div>
                                </li>   
                                @endif    
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted">{{date("d/m/Y  h:i:s a",strtotime($request->arrived_at))}}</div>
                                    </div>
                                </li>          
                                @endif    
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted">{{date("d/m/Y  h:i:s a",strtotime($request->completed_at))}}</div>
                                    </div>
                                </li>   
                                @endif    
                                ...
                                <li class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div class="text-muted">{{date("d/m/Y  h:i:s a",strtotime($request->cancelled_at))}}</div>
                                    </div>
                                </li>    
                                @endif     
                            </ul>
                ...
                @if(!$request->is_cancelled)
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                <li class="list-group-item">@if($request->trip_type != "OUTSTATION"){{ __('base_price') }}@else{{ __('driver_beta') }}@endif <span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->base_price : ($request->is_later == 0 ? ($request->getZonePrice ? $request->getZonePrice->ridenow_base_price : ($request->outstationPriceDetails ? $request->outstationPriceDetails->distance_price : $request->getPackageItem->price)) : ($request->getZonePrice ? $request->getZonePrice->ridelater_base_price : ($request->outstationPriceDetails ? $request->outstationPriceDetails->distance_price : "0.00")))}}</span></li>
                                @if($request->requestBill != Null)
                                @if($outstation_trip)<li class="list-group-item font-weight-semibold">{{ __('trip_start') }}<span class="ml-auto">{{$outstation_trip ? $outstation_trip->trip_start_km : '0.00'}} Km</span></li>@endif
                                @if($outstation_trip) <li class="list-group-item font-weight-semibold">{{ __('trip_end') }}<span class="ml-auto">{{$outstation_trip ? $outstation_trip->trip_end_km : '0.00'}} Km</span></li>@endif
                                    ...
                                    @if($request->requestBill->hill_station_price != '0.00')<li class="list-group-item">{{ __('hill_station_price')}} <span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->hill_station_price}} {{$request->requestBill ? $request->requestBill->hill_station_price : '0.00'}}</span></li>@endif
                                    ...
                                    <li class="list-group-item text-danger">{{ __('roda_commission')}}<span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->admin_commision : '0.00'}}</span></li>
                                    <li class="list-group-item text-danger">{{ __('service_tax')}}<span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->service_tax : '0.00'}}</span></li>
                ...
                @if(!$request->is_cancelled)
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                <li class="list-group-item">@if($request->trip_type != "OUTSTATION"){{ __('base_price') }}@else{{ __('driver_cost') }}@endif <span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->base_price : ($request->is_later == 0 ? ($request->getZonePrice ? $request->getZonePrice->ridenow_base_price : ($request->outstationPriceDetails ? $request->outstationPriceDetails->distance_price : $request->getPackageItem->price)) : ($request->getZonePrice ? $request->getZonePrice->ridelater_base_price : ($request->outstationPriceDetails ? $request->outstationPriceDetails->distance_price : "0.00")))}}</span></li>
                                @if($request->requestBill != Null)
                                    @if($request->requestBill->distance_price != '0.00')<li class="list-group-item">
                                    
                                    <div class="media">
                                        <div class="media-body">
                                            <div class="media-title ">Distance Price</div>
                                            @if($request->trip_type != "LOCAL")
                                            <div class="media-title font-weight-semibold">( @if($request->trip_type != "OUTSTATION")  {{$request->requestBill ? $request->requestBill->pending_km : '0.00'}}@else{{$request->requestBill ? $request->requestBill->total_distance : '0.00'}}@endif Km * {{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->price_per_distance : '0.00'}})</div>@endif
                                         </div>
                                    </div> 
                                    <span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->distance_price : '0.00'}}</span></li>@endif
                                    @if($request->requestBill->hill_station_price != '0.00')<li class="list-group-item">{{ __('hill_station_price')}} <span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->hill_station_price}} {{$request->requestBill ? $request->requestBill->hill_station_price : '0.00'}}</span></li>@endif
